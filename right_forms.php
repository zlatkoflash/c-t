<?php
	...
	class RightForms
	{
            	...
            	<div>
                    ...
                    <div class="holderRightParceForm___intoForm">
                        ...
                        Logo will not show on the cheque image to the left,<br />
                                ...
                                onclick="CreatingInvoiceForAdditionalProducts.CIFAP.setupIDs_and_Indexes_ForSubmit();CompanyInfo.CI.CBLogoOnClick(this);OrderTotalAmount.OTA.calculate();" />
                                <span id="one_time_charge_label">
                                Attach Logo - Black Ink Only $<span class="logo_price_label">15</span> one time charge. 
                                </span>
                                <br />
                                <input type="checkbox" class="widthAUTO borderStyleNONE heightAUTO" id="compInfoAttachLogo_2" onclick="CreatingInvoiceForAdditionalProducts.CIFAP.setupIDs_and_Indexes_ForSubmit();CompanyInfo.CI.CBLogoOnClick(this);OrderTotalAmount.OTA.calculate();" />
                    ...
                    <div class="holderRightParceForm___intoForm alignCenter">
                        ...
                        <!--<div class="displayNone">-->
                       	<div id="add45OnAccountNumber">
                        	...
                        	<br/>
                        	<input onclick="CompanyInfo.CI.usFundsShowOnCheque();CompanyInfo.CI.showTheNumbers();" type="radio" value="yes" class="validate[required]" name="add_45_after_account" id="add_45_after_account_yes" />Yes 
                        	<input onclick="CompanyInfo.CI.usFundsShowOnCheque();CompanyInfo.CI.showTheNumbers();" type="radio" value="no" class="validate[required]" name="add_45_after_account" id="add_45_after_account_no" />No
                        	<script>
                        		<?php
                        			if(self::$IS_FOR_SHOWING_ORDER_FOR_ADMIN)
                        			{
		...
		function draw_additionalProducts()
		{
			?>
			 ...
			 RightForms::CREATE_INPUTS_INVISIBLE(array("depositBooksINPUTIndex", "depositBooksINPUTIndex", "DWEINPUTIndex", "SSDWEINPUTIndex", "chequeBinderINPUTIndex", "SelfLinkStampINPUTIndex"), 
			 									 array("0","0","0","0","0","0"));
				*/
			 RightForms::CREATE_INPUTS_INVISIBLE(array("additional_products_IDs", "additionalProducts_indexes"), 
            ...
            <!--
            	...
            	<div class="holderRightParceForm">
                    ...
                    <div class="holderRightParceForm___intoForm positionRelative deliveryFormInto">
                    	...
                    	<div>
                        	<input type=radio name="deliveryTypeRadioOption" id="standard_8to10_business_days" checked="checked" onclick="CreatingInvoiceForAdditionalProducts.CIFAP.setupIDs_and_Indexes_ForSubmit();Delivery.D.setup_delivery_details();" /> Standard 8-10 Business Days
                        </div>
                    	<div>
                        	<input type=radio name="deliveryTypeRadioOption" id="rush_25charge_1to5_business_days" onclick="CreatingInvoiceForAdditionalProducts.CIFAP.setupIDs_and_Indexes_ForSubmit();Delivery.D.setup_delivery_details();" /> 
		...
		function draw_totalAmount()
		{
            ...
            <?php
			RightForms::CREATE_INPUTS_INVISIBLE(array("sub_total_products_INPUT", "shipping_price_INPUT", "sub_total_taxes_INPUT", "grand_total_INPUT", "percentTaxesInput"), 
												array("0", "0", "0", "0", "0"));
		}
		/////////////////////////////////////////////////////////////////////////
		/*
  ...
  CreatingInvoiceForAdditionalProducts.CIFAP.create( CreatingInvoiceForAdditionalProducts.TYPE_RECEIPT );
            ...
            <script>
            	...
            	function InvoiceModerator()
            	{
            		...
            		{
            			if($("#cb_invoice_do_not_sent_email").prop("checked")){return "0";}
            			if($("#cb_invoice_send_to_billing_address").prop("checked")){return "1";}
            			return "0";
            		}
            		this.send_to_custom_address = function()
            		{
            			if($("#cb_invoice_do_not_sent_email").prop("checked")){return "0";}
            			if($("#cb_invoice_send_to_custom_email_address").prop("checked")){return "1";}
            			return "0";
            		}
