				...
				?>
					<script>
						...
						<div id="admin_left_part" class="floatLEft">
	                        ...
	                        -->
	                        <?php
	                        	RightForms::CREATE_INPUTS_INVISIBLE(array("fso_admin_submit_additions"), 
													array("0,0,0"));
	                        ?>
	                        <?php
	                        //print_r( $_POST );
	                        ...
	                        <div class="marginBottom10px">
	                            ...
	                            <div>
									...
									(
										array("sales_person_code_order_entered_by"), 
										array("-1;;-1;")
									);
									?>
	                                <script>
	                            ...
	                            <div>
	                                ...
	                                <?php
	                                 RightForms::CREATE_INPUTS_INVISIBLE
									(
										array("order_submited_date_order_updated_date"), 
										array(";")
									);
									?>
	                                <!--
                  ...
                  new Date(1000*<?php print $_POST["date_for_new_submited_order"]; ?>) );
	                            ...
	                            <script>
									...
									function SubmitAdminAdditions()
									{
										...
										{
											if($("#cb_doNotSentEmailToCustomerFromAdmin").prop("checked")){return "0";}
			...
			*/
			?>
				<script>
					...
					?>
					<?php if($_POST["chequeType"]==Cheque::TYPE_LASER)
						{
