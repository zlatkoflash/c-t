...
<?php
/*
  Template Name: Admin Orders Navigator
...
<?php require_once(get_template_directory().'/search.php'); ?>
<?php require_once get_template_directory().'/templates/admin/directions.php'; ?>
