<?php
	...
	class BlankA4Cheque
	{
		...
		public function BlankA4Cheque( $chequeData____, $__iMReorderForm___=false, $iMForCheque___=false )
		{
			...
			else if($this->iMReorderForm == true)
			{
				...
				$this->pdf->MultiCell(100,50,$this->chequeData->quantityCountFree(),$this->border,"C");
			}
			
		...
		*/
		...
		{
			$startY = 0;
			$this->pdf->Image($this->chequeData->backgroundURLForOrder(), 0, 0, 280);
			/*
		...
		function addCompanyNameOnCenter($isBottom)
		{
			...
			{
				$plusYForMe = 2;
				$this->pdf->SetXY(PDFHelper::pixels_to_MM(428), $pozYFor-5+$plusYForMe);
				$this->pdf->SetFont("helvetica_bold", "", 10);
				$this->pdf->MultiCell(PDFHelper::pixels_to_MM(340),PDFHelper::points_to_MM(12),$this->chequeData->CINACompanyName(),$this->border,"C");
				
				$this->pdf->SetXY(PDFHelper::pixels_to_MM(428), $pozYFor+$plusYForMe);
				$this->pdf->SetFont("helvetica", "", 8);
				$this->pdf->MultiCell(PDFHelper::pixels_to_MM(340),2.8,$this->chequeData->compInfoAddressLine1()."\n".$this->chequeData->compInfoAddressLine2()."\n".$this->chequeData->compInfoAddressLine3()."\n".$this->chequeData->compInfoAddressLine4(),$this->border,"C");
			}
			else if($this->chequeData->CINACompanySecondName() != "")
			{
				$plusYForMe=0;
				$this->pdf->SetXY(PDFHelper::pixels_to_MM(428), $pozYFor-5.2);
				$this->pdf->SetFont("helvetica_bold", "", 10);
				$this->pdf->MultiCell(PDFHelper::pixels_to_MM(340),PDFHelper::points_to_MM(12),$this->chequeData->CINACompanyName(),$this->border,"C");
				$this->pdf->SetFont('helvetica_bold','',10);
				$this->pdf->SetXY(PDFHelper::pixels_to_MM(428), $pozYFor-1.7); 
				$this->pdf->MultiCell(PDFHelper::pixels_to_MM(340),PDFHelper::points_to_MM(12),$this->chequeData->CINACompanySecondName()."",$this->border,"C");
				
				$this->pdf->SetXY(PDFHelper::pixels_to_MM(428), $pozYFor+3.0);
				$this->pdf->SetFont("helvetica", "", 8);
				$this->pdf->MultiCell(PDFHelper::pixels_to_MM(340),2.8,$this->chequeData->compInfoAddressLine1()."\n".$this->chequeData->compInfoAddressLine2()."\n".$this->chequeData->compInfoAddressLine3()."\n".$this->chequeData->compInfoAddressLine4(),$this->border,"C");
			}
		...
		function addAccountsNumbers( $isBottom )
		{
			...
			if($this->iMForCheque==true)
			{
				...
				$this->pdf->SetXY(PDFHelper::pixels_to_MM(890), $pozPlusY-70);
				if($isBottom==false)
				{
					$this->pdf->MultiCell(PDFHelper::pixels_to_MM(150),PDFHelper::points_to_MM(20),$this->chequeData->startAtNumber(),$this->border,"R");
				}
				else
				{
					$this->pdf->MultiCell(PDFHelper::pixels_to_MM(150),PDFHelper::points_to_MM(20),$this->chequeData->startAtNumber_plus_1(),$this->border,"R");
				}
				$this->pdf->SetFont("helvetica", "", 16);
				$this->pdf->SetXY(53, $pozPlusY-69);
				if($isBottom==false)
				{
					$this->pdf->MultiCell(PDFHelper::pixels_to_MM(150),PDFHelper::points_to_MM(20),$this->chequeData->startAtNumber(),$this->border,"R");
				}
	...
	XMLParser::ADD_ORDER_XML_TO_POST( "orders/xml/T_M3532.xml" );
