...
class BluePayment {
 ...
 protected $transType="SALE"; // TRANS_TYPE (AUTH, SALE, REFUND, or CAPTURE)
 ...
 const ACCOUNT_ID = '100073017708'; // the default account id
 const SECRET_KEY = 'EMQH5GHLUX9JBZMSYQDOJ.LDZZ.OWWEI'; // the default secret key
 ...
 */
 ...
 public function getRebid() { return $this->rebid; }
	 ...
	 {
		 ?>
         			<div id="creaditCartBluePay" style="display:none;">
                        <div class="floatLEft">
                            <div class="lineTextHeight22 marginBottom2px height22PX">Account:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">CVV2:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">Expire:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">First Name:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">Last Name:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">Address:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">City:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">State:</div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">Zip Code:</div>
                        ...
                        <div class="floatLEft">
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="account" value="4111111111111111" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="cvv2" value="123" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="expire" value="1985" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="firstName" value="Muhammad" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="lastName" value="Nassem" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="address" value="Address" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="city" value="Pakistan" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">
                            	<select id="bluePaySelectPRovinces">
                                ...
                                <?php
                                    RightForms::CREATE_INPUTS_INVISIBLE(array( "provinceBLuePay"), array(""));
                                ?>
                            </div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="ZIP" value="6000" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX">
                                <select id="countryPaymentOptionsBluePay" onchange="objGateWay.setCountrie();">
                                    <option>-Country-</option>
                                    <?php 
										HELPWordpress::ALL_COUNTRIES_OPTIONS_ADD(); 
                                        //HELPWordpress::ALL_US_CANADA_OPTIONS_ADD();
									?>
                                </select>
                                <?php
                                    RightForms::CREATE_INPUTS_INVISIBLE(array( "countryBluePay"), array(""));
                                ?>
                            </div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="phone" value="+384222666777" /></div>
                            <div class="lineTextHeight22 marginBottom2px height22PX"><input type="text" name="email" value="muhamad.nasim@gmail.com" /></div>
                        </div>
...
echo 'Response: '. $bp->getResponse() .'<br />'.
 ...
 'Rebid: '. $bp->getRebid();END EXAMPLE */
/*
getStatus can be this variables...
 const STATUS_DECLINE = '0'; // DECLINE
 const STATUS_APPROVED = '1'; // APPROVED
 const STATUS_ERROR = 'E'; // ERROR
 */
