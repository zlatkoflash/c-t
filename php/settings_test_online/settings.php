<?php
	...
	class SETTINGS
	{
		...
		const URL_TO_ADMIN_PAGE="https://chequesnow.ca/test/admin/";
                ...
                const URL_TO_ADMIN_PAGE_AFTER_SUBMIT_ORDER = "http://chequesnow.ca/test/admin-after-submit-order/";
                
                const URL_TO_REDIRECTION_FOR_CONTRIBUTERS = "http://chequesnow.ca/test/admin-orders-navigator/";
