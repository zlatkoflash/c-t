<?php
	if(!class_exists("Cheque")){require_once( "tools.php" );}
		...
		public static function initTheHTMLForm()
		{
			...
			?>			
						...
						this.setup = function(visibleInputs, _productObject_, _input_id_roll_overed_, _array_js_products_)
						{
							...
							if(this.indexHideInterval != null){clearTimeout(this.indexHideInterval);}
			...
			?>	
							...
							{
								if(this.productObject.id == null){this.productObject.id = "-666";}
								$.post(settings.URL_TO_PHP_PRODUCTS, 
								{
	...
	{	
		...
		public function description()
		{
			switch($this->array_name)
			{
				...
				case self::TYPE_DEPOSIT_BOOKS:{return "Deposit Books";}break;
				case self::TYPE_DWE_LIST:{return "Double Window Envelopes";}break;
				case self::TYPE_SSDWE_LIST:{return "Self Seal Double Window Envelopes";}break;
				case self::TYPE_CHEQUE_BINDER_LIST:{return "Cheque Binder";}break;
				case self::TYPE_SELF_INCING_STAMP:
				{
					if($this->additional_type == "name"){return "Name & Address Stamp";}
					if($this->additional_type == "deposit"){return "Deposit Stamp";}
					return "Deposit Stamp";
				}break;
				case self::TYPE_LOGO_PRODUCT:{return "Logo";}break;
				case self::TYPE_RUSH_PRODUCT:{return "Rush Production";}break;
			}
			if($this->id == "-666")
			{
