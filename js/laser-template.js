...
function LaserTemplates()
{
    ...
    {
        if (this.chequeWithBg == "")
        {
            this.chequeWithBg = $("#cheque_with_bg_template").html();
            $("#cheque_with_bg_template").html("");
        }
        if (this.blank_1 == "")
        {
            this.blank_1 = $("#template_blank_1").html();
            $("#template_blank_1").html("");
        }
        if (this.blank_2 == "")
        {
            this.blank_2 = $("#template_blank_2").html();
            $("#template_blank_2").html("");
        }
        ...
        $("#watermarkIMG").attr("src", HELPER.H.PATH_TO_THEME + "/images/backgrounds/watermark.png");
    }
}